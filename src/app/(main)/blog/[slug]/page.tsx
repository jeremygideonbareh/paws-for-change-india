    ...
    <article className="relative bg-background py-24">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        <div className="absolute top-[5%] right-[3%] h-32 w-32 overflow-hidden rounded-2xl opacity-[0.04]">
          <img src="https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=220&q=60&fm=webp&fit=crop" alt="" className="h-full w-full object-cover" />
        </div>
        <div className="absolute bottom-[10%] left-[2%] h-28 w-28 overflow-hidden rounded-2xl opacity-[0.04]">
          <img src="https://images.unsplash.com/photo-1600804340584-c7db2eacf0bf?w=200&q=60&fm=webp&fit=crop" alt="" className="h-full w-full object-cover" />
        </div>
      </div>
